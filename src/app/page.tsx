    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="bg-gradient-to-r from-[#1e3a5f] to-[#2563eb] text-white shadow-lg">
        <div className="max-w-3xl mx-auto px-4 py-6">
          <p className="text-blue-200 text-sm font-medium mb-0.5">技術士一次試験</p>
          <h1 className="text-3xl font-bold leading-tight">基礎科目</h1>
          <p className="text-blue-200 text-base mt-0.5">練習問題</p>
